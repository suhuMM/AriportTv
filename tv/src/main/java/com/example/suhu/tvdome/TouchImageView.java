    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_DPAD_CENTER:
                //中间键
                Toast.makeText(context,"中间键",Toast.LENGTH_SHORT).show();

                break;

            case KeyEvent.KEYCODE_DPAD_DOWN:
                //下方向键
                Toast.makeText(context,"下方向键",Toast.LENGTH_SHORT).show();
            ...
            case KeyEvent.KEYCODE_DPAD_LEFT:
                //左方向键
                Toast.makeText(context,"左方向键",Toast.LENGTH_SHORT).show();
            ...
            case KeyEvent.KEYCODE_DPAD_RIGHT:
                //右方向键
                Toast.makeText(context,"右方向键",Toast.LENGTH_SHORT).show();
                matrix.postTranslate(-50,0);
                break;

            case KeyEvent.KEYCODE_DPAD_UP:
                //上方向键
                Toast.makeText(context,"上方向键",Toast.LENGTH_SHORT).show();
                matrix.postTranslate(0,-50);
                break;

            case KeyEvent.KEYCODE_NUMPAD_ADD:
                //加
                matrix.postScale(2f,2f,widthScreen/2,heightScreen/2);
                break;

            case KeyEvent.KEYCODE_NUMPAD_SUBTRACT:
                //减
                matrix.postScale(0.5f,0.5f,widthScreen/2,heightScreen/2);
                break;
        }
        invalidate();
